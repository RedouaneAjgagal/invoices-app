    ...
    return (
        <div className='flex flex-col gap-4'>
            <div className='flex flex-col gap-2'>
                ...
                <input type='text' id={nameId} name='itemName' defaultValue={props.values?.name} className={`outline-none dark:bg-darkBlue border hover:dark:border-primaryPurple hover:border-primaryPurple duration-300 ease-linear bg-white p-3 rounded font-medium ${newError.itemName ? 'dark:border-red-600 border-red-600' : 'dark:border-slate-800 border-slate-300'}`} />
            ...
            <div className='grid grid-cols-5 gap-3'>
                <div>
                    <div className='flex flex-col gap-2'>
                        ...
                        <input onChange={getValue} type='number' id={quantityId} name='itemQty' defaultValue={props.values?.quantity || 1} className={`outline-none dark:bg-darkBlue border hover:dark:border-primaryPurple hover:border-primaryPurple duration-300 ease-linear bg-white p-3 rounded font-medium ${newError.itemQty ? 'dark:border-red-600 border-red-600' : 'dark:border-slate-800 border-slate-300'}`} />
                ...
                <div className='col-span-2'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <input onChange={getValue} type='number' id={priceId} name='itemPrice' defaultValue={props.values?.price || 0} className={`outline-none dark:bg-darkBlue border hover:dark:border-primaryPurple hover:border-primaryPurple duration-300 ease-linear bg-white p-3 rounded font-medium ${newError.itemPrice ? 'dark:border-red-600 border-red-600' : 'dark:border-slate-800 border-slate-300'}`} />
                    </div>
