...
const Input: React.FC<Props> = (props) => {
    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <input type={props.type} id={props.id} name={props.name ? props.name : props.id} defaultValue={value} className={`outline-none dark:bg-darkBlue border dark:border-slate-800 hover:dark:border-primaryPurple hover:border-primaryPurple duration-300 ease-linear bg-white p-3 rounded font-medium ${error && 'dark:border-red-600 border-red-600'}`} />
