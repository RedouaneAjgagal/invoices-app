...
const Navbar = () => {
    return (
        <nav className='dark:bg-darkBlue bg-lightDarkBlue flex justify-between items-center shadow-lg'>
            <div className='bg-primaryPurple relative z-20 rounded-r-3xl after:content-[""] after:w-full after:h-[50%] after:bg-indigo-200/25 after:rounded-br-3xl after:rounded-tl-3xl after:absolute after:bottom-0 after:left-0 after:-z-10'>
                <Link to='/'><img src={logo} alt="invoices-logo" className='p-6 w-[5.5rem]' /></Link>
            </div>
            <div className='flex items-center gap-4'>
                <button><HiSun className='text-2xl'/></button>
