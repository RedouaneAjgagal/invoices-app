...
const Invoice: React.FC<InvoiceData> = (props) => {
    ...
    return (
        <li className='dark:bg-darkBlue bg-white rounded-lg shadow-xl'>
            <Link to={id} className='grid grid-cols-2 p-4 border border-transparent hover:border-primaryPurple rounded-lg  duration-300 ease-in-out md:grid-cols-5 items-center '>
