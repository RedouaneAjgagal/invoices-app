...
const Total: React.FC<Props> = (props) => {
    ...
    return (
        <div className='px-4 h-24 dark:bg-black/75 bg-slate-700 flex justify-between items-center rounded-b-lg'>
            <p className='text-[.9rem] text-white'>Amount Due</p>
            <span className='font-medium text-2xl text-white'>{total}</span>
        </div>
    )
}
