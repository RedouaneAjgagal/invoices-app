...
const Delete = () => {
    ...
    return (
        <>
            <div className='fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 dark:bg-darkerBlue bg-white w-full max-w-md z-50 p-10 rounded flex flex-col gap-6 shadow-lg'>
                <h2 className='text-3xl font-medium'>Confirm Deletion</h2>
                <p>Are you sure you want to delete invoice #{targetId}? This action cannot be undone.</p>
